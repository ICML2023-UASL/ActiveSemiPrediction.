...
set.seed(20230710)
beta = c(-5.4, rep(0.7,7));re=300; t.n = 10000; m1 = 10;deg = 2; batch =80; pilot <- 120
...
pdf(file = "~/Desktop/RPlot17.pdf", width = 8, height = 5)
...
pdf(file = "~/Desktop/RPlot18.pdf", width = 8, height = 5)
par(mar = c(5.1, 6.1, 4.1, 1.1))
