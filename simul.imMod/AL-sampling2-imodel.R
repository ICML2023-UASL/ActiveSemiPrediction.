...
set.seed(20230810)
beta = c(-3, rep(0.7,7));re=300; t.n = 10000; m1 = 10;deg = 1; batch = 100; pilot <- 150
...
for(i in 1:re)
{
  ...
  imp.moe.all = m.t(pilot.Y, pilot.X, pool.X, sub.p.u, deg, method = 'Perfect', link = 'mod2')$i.model
  ...
  { 
    ...
    set.ses.CW.all = SES(set.ses.CW.all$pool.x, set.ses.CW.all$pool.y, set.ses.CW.all$sub.x, set.ses.CW.all$sub.y, set.ses.CW.all$sub.p, batch, set.ses.CW.all$c.est, set.ses.CW.all$i.model,link = 'mod2')
    set.ses.IMP.all = SES(set.ses.IMP.all$pool.x, set.ses.IMP.all$pool.y, set.ses.IMP.all$sub.x, set.ses.IMP.all$sub.y, set.ses.IMP.all$sub.p, batch, set.ses.IMP.all$c.est, set.ses.IMP.all$i.model,link = 'mod2') 
    ...
    set.ses.CW.all$i.model <- m.t(set.ses.CW.all$sub.y, set.ses.CW.all$sub.x, set.ses.CW.all$pool.x, set.ses.CW.all$pi, deg, method = 'Perfect', link = 'mod2')$i.model
    ...
    fit.AI.IMP.all = m.t(set.ses.IMP.all$sub.y, set.ses.IMP.all$sub.x, set.ses.IMP.all$pool.x, set.ses.IMP.all$pi, deg, method = 'Perfect', link = 'mod2')
...
pdf(file = "~/Desktop/RPlot27.pdf", width = 8, height = 5)
...
pdf(file = "~/Desktop/RPlot28.pdf", width = 8, height = 5)
par(mar = c(5.1, 6.1, 4.1, 1.1))
