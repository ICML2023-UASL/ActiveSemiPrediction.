...
for(i in 1:re)
{
  ...
  imp.moe.all = m.t(pilot.Y, pilot.X, pool.X, sub.p.u, deg, method = 'IMP')$i.model
  ...
  { 
     ...
     set.ses.CW.all = SES(set.ses.CW.all$pool.x, set.ses.CW.all$pool.y, set.ses.CW.all$sub.x, set.ses.CW.all$sub.y, set.ses.CW.all$sub.p, batch, set.ses.CW.all$c.est, set.ses.CW.all$i.model)
     set.ses.IMP.all = SES(set.ses.IMP.all$pool.x, set.ses.IMP.all$pool.y, set.ses.IMP.all$sub.x, set.ses.IMP.all$sub.y, set.ses.IMP.all$sub.p, batch, set.ses.IMP.all$c.est, set.ses.IMP.all$i.model) 
     ...
     set.ses.CW.all$i.model <- m.t(set.ses.CW.all$sub.y, set.ses.CW.all$sub.x, set.ses.CW.all$pool.x, set.ses.CW.all$pi, deg, method = 'IMP')$i.model
     ...
     fit.AI.IMP.all = m.t(set.ses.IMP.all$sub.y, set.ses.IMP.all$sub.x, set.ses.IMP.all$pool.x, set.ses.IMP.all$pi, deg, method = 'IMP')
...
pdf(file = "~/Desktop/RPlot25.pdf", width = 8, height = 5)
par(mar = c(5.1, 6.1, 4.1, 1.1))
plot(tab3, ylim = c(min(tab4),max(tab1)) ,xaxt = "n",  cex.lab=2.5, lty = 6,
...
pdf(file = "~/Desktop/RPlot26.pdf", width = 8, height = 5)
par(mar = c(5.1, 6.1, 4.1, 1.1))
